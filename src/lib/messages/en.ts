export const en = {
  ...
  "reader.normalizationHint": "Case, accents, punctuation and line breaks are ignored.",
  "reader.tapHint": "Tap a letter to see its mirror, or use the controls below.",
  "reader.noLetters": "No letters to compare",
  "reader.stepPrev": "Previous pair",
  "reader.stepNext": "Next pair",
  "reader.stepCenter": "Center",
  "reader.pairLabel": "Pair {n} of {m}",
  "reader.centerPair": "Center pair",
  "reader.legendMirror": "current mirror pair",
  "reader.legendAria": "reader legend",
