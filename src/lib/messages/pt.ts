...
export const pt: Table = {
  ...
  "reader.edit": "Editar",
  "reader.normalizationHint": "Maiúsculas, acentos, pontuação e quebras de linha são ignorados.",
  "reader.tapHint": "Toque numa letra para ver o seu espelho, ou use os controlos abaixo.",
  "reader.noLetters": "Não há letras para comparar",
  "reader.stepPrev": "Par anterior",
  "reader.stepNext": "Par seguinte",
  "reader.stepCenter": "Centro",
  "reader.pairLabel": "Par {n} de {m}",
  "reader.centerPair": "Par central",
  "reader.legendMirror": "par espelhado atual",
  "reader.legendAria": "legenda do leitor",
  ...
  "account.formTitle": "Explorar uma conta",
  "account.formHint": "Digite um handle, DID ou link de perfil.",
  "account.hint": "Publicações e respostas públicas desta conta que contêm um palíndromo.",
  "account.placeholder": "alice.bsky.social ou bsky.app/profile/…",
  "account.button": "Explorar conta",
  "account.heading": "Palíndromos de",
  "account.back": "Voltar à Exploração",
  "account.empty": "Nenhum palíndromo foi encontrado nas publicações carregadas.",
  "account.restricted":
    "Nenhum palíndromo pode ser mostrado porque as publicações carregadas até agora são restritas.",
  "account.noneInPage": "Nenhum palíndromo nas publicações mais recentes.",
  "account.invalid": "Essa conta não parece válida.",
  "account.notFound": "Essa conta não está disponível.",
  "account.nextError": "Não foi possível carregar publicações mais antigas.",
  "account.loadOlder": "Carregar publicações mais antigas",
  "account.loadingMore": "Carregando…",
  ...
  "post.originalLabel": "Publicação original",
};
