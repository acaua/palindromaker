...
export const fr: Table = {
  ...
  "account.formTitle": "Explorer un compte",
  "account.formHint": "Saisissez un handle, un DID ou un lien de profil.",
  "account.hint": "Publications et réponses publiques de ce compte qui contiennent un palindrome.",
  "account.placeholder": "alice.bsky.social ou bsky.app/profile/…",
  "account.button": "Explorer le compte",
  "account.heading": "Palindromes de",
  "account.back": "Retour à Explorer",
  "account.empty": "Aucun palindrome n’a été trouvé dans les publications chargées.",
  "account.restricted":
    "Aucun palindrome ne peut être affiché, car les publications chargées jusqu’ici sont restreintes.",
  "account.noneInPage": "Aucun palindrome dans les publications les plus récentes.",
  "account.invalid": "Ce compte ne semble pas valide.",
  "account.notFound": "Ce compte n’est pas disponible.",
  "account.nextError": "Impossible de charger les publications plus anciennes.",
  "account.loadOlder": "Charger les publications plus anciennes",
  "account.loadingMore": "Chargement…",
  ...
  "post.viewPalindromeCard": "Voir le palindrome",
  "post.viewCard": "Voir la publication",
  "post.palindromeLabel": "Palindrome",
  "post.originalLabel": "Publication originale",
};
