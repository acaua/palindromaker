...
export const es: Table = {
  ...
  "reader.normalizationHint":
    "No se tienen en cuenta mayúsculas, acentos, puntuación ni saltos de línea.",
  "reader.tapHint": "Toca una letra para ver su espejo, o usa los controles de abajo.",
  "reader.noLetters": "No hay letras que comparar",
  "reader.stepPrev": "Par anterior",
  "reader.stepNext": "Par siguiente",
  "reader.stepCenter": "Centro",
  "reader.pairLabel": "Par {n} de {m}",
  "reader.centerPair": "Par central",
  "reader.legendMirror": "par espejo actual",
  "reader.legendAria": "leyenda del lector",
